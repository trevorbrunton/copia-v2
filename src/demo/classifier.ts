...
const patterns: Pattern[] = [
  ...
  },
  {
    ...
    keywords: ["tell me about the fund", "fund overview", "overview of the fund", "overview of the mid", "what is the fund", "describe the fund", "summary of the fund", "about the fund", "about the mid-cap", "about the midcap", "about your fund"],
    weight: 1,
  },
  {
