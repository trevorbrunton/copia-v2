...
purpose: "TDD-based feature and code implementation with intelligent persona activation"
wave-enabled: true
...
- **Arguments**: `[feature-description]`, `--type component|api|service|feature`, `--framework <name>`, `--tdd-strict`, `--<flags>`
