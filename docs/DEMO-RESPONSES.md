...
**Source:** `src/db/migrations/002_demo_responses.sql` and `003_additional_demo_responses.sql`
...
**Label:** What is the investment strategy?
...
**Label:** Rate of return since inception?
...
**Label:** Year-to-date and recent performance?
...
**Label:** How does performance compare to the benchmark?
...
**Label:** What is the OC Mid-Cap Fund?
...
**Label:** Key fund details and identifiers?
...
**Label:** What is the minimum investment?
...
**Label:** How are distributions paid?
...
**Label:** What stocks does the fund invest in?
...
**Label:** What are some example holdings?
...
**Label:** Why invest in mid-cap stocks?
...
**Label:** About OC Funds Management?
...
**Label:** Who is on the investment team?
...
**Label:** What ratings does the fund have?
...
**Label:** What is your approach to ESG?
...
**Label:** What other funds does OC manage?
...
**Label:** What is Copia Investment Partners?
...
**Label:** Tell me about the MLC mandate?
...
**Label:** How do I withdraw my money?
...
**Label:** Is there a cooling-off period?
...
**Label:** Why choose active management?
